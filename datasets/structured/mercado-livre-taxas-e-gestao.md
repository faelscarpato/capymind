# Mercado Livre Taxas e Gestao

Resumo curto: base descrita em markdown, sem ingestao massiva do arquivo original.

## Origem
- Caminho original: `D:\novosproj\PROJETOS 2026\MERCADO LIVRE\planilha_taxas_ml.xlsx`

## Detectado
- Finalidade percebida: Planilhas operacionais de taxa, gestao e margem para a operacao comercial.
- Estrutura / campos: comissoes, frete, margem, repasse, estoque e controle gerencial
